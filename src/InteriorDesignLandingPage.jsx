  ...
  return (
    <div className="bg-offwhite font-inter text-charcoal">
        ...
        <div className="bg-gray-100 py-4">
          <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
            ...
            <div className="flex items-center">
              <div className="bg-red-600 w-16 h-16 flex flex-col items-center justify-center text-white font-bold">
                <div className="text-lg leading-tight">IN-SITE</div>
                <div className="text-xs leading-tight">INTERIOR DESIGN</div>
              </div>
            </div>
      ...
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        >
          <motion.p 
            className="font-playfair text-5xl md:text-6xl font-light italic leading-relaxed mb-8"
            variants={fadeInUp}
          >
